...
const [otp,setOtp]=useState("")
  ...
  return (
    ...
    items-center' >
        ...
        <button className='w-[70%] px-[20px] py-[10px] bg-black
            text-white
            font-semibold h-[50px] cursor-pointer rounded-2xl mt-[30px]'  disabled={loading} onClick={() => handleStep1()}>{loading?<ClipLoader size={30} color='white' />:"Send OTP"}
        </button>
        ...
        <button className='w-[70%] px-[20px] py-[10px] bg-black
            text-white
            font-semibold h-[50px] cursor-pointer rounded-2xl mt-[30px]' disabled={loading} onClick={() => handleStep2()}>{loading?<ClipLoader size={30} color='white' />:"Submit"}
        </button>
        ...
        <div  className='relative flex items-center mt-[30px] justify-start w-[90%] h-[50px] rounded-2xl border-2 border-black '
          onClick={()=>setInputClicked({...inputClicked,confirmNewPassword:true})} >
            ...
            <label htmlFor='confirmNewPassword' className={`pointer-events-none text-gray-700 absolute left-[20px] p-[5px] bg-white text-[15px] ${inputClicked.confirmNewPassword?"top-[-15px]":""}` }>Confirm New Password</label>
        ...
        <button className='w-[70%] px-[20px] py-[10px] bg-black
            text-white
            font-semibold h-[50px] cursor-pointer rounded-2xl mt-[30px]'  disabled={loading} onClick={() => handleStep3()}>{loading?<ClipLoader size={30} color='white' />:"Reset Password"}
        </button>
