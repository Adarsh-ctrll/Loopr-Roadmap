...
<div className="w-[40px] h-[40px] rounded-full overflow-hidden border-2 border-purple-300">
{noti.post && (
...
{noti.loop && (
  <video src={noti.loop.media} muted loop className="h-full w-full object-cover" />
)}
