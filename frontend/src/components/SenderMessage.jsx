...
function SenderMessage({message}) {
  ...
  return (
    <div ref={scroll} className="w-fit max-w-[60%] bg-gradient-to-r
      from-purple-600
      via-pink-500
      to-orange-400 rounded-t-2xl rounded-bl-2xl rounded-br-0 px-[10px] relative ml-auto right-0 flex  flex-col gap-[10px]">
