...
navigate(`/story/${userData.userName}`)
  ...
  return (
    <div className='flex flex-col w-[80px]' >
      <div className={`w-[80px] h-[80px] ${!story?null:!viewed?"bg-gradient-to-b from-blue-500 to-blue-950 ":"bg-gradient-to-b from-gray-500 to-black-950 "} rounded-full  flex justify-center items-center relative` } onClick={handleClick}  >
            <div className='w-[70px] h-[70px] border-2 border-black rounded-full cursor-pointer overflow-hidden'  >
                <img src={  ProfileImage || dp} alt="" className="w-full object-cover" />
                {!story && userName=="Your Story" && <div>
                 <div>
                <LuBadgePlus className="text-black absolute bottom-[10px] bg-white right-[10px] rounded-full w-[22px] h-[22px] "/>
                </div>
