...
import getSuggestedUsers from './hooks/getSuggetedUsers'
...
<Route
  path="/roadmaps"
  element={userData ? <Roadmaps /> : <Navigate to="/signin" />}
/>
<Route
  path="/roadmap/:roadmapId"
  element={userData ? <RoadmapDetail /> : <Navigate to="/signin" />}
/>
<Route
  path="/my-roadmaps"
  element={userData ? <MyRoadmaps /> : <Navigate to="/signin" />}
/>
<Route
  path="/milestones"
  element={userData ? <Milestones /> : <Navigate to="/signin" />}
/>
<Route
  path="/anonymous"
  element={userData ? <Anonymous /> : <Navigate to="/signin" />}
/>
    </Routes>
  )
}
